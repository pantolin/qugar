...
jupytext_process.process_python_demos(
    input_dir="../python/demo", output_dir="./generated/demos"
)
...
breathe_projects = {"QUGaR": "./build/doxygen_xml/"}
breathe_default_project = "QUGaR"
breathe_implementation_filename_extensions = [".c", ".cc", ".cpp"]
html_extra_path = ["./build/doxygen_html", "./generated"]
