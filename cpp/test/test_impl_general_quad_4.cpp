...
//! @file test_impl_impl_general_quad_4.cpp
//! @author Pablo Antolin (pablo.antolin@epfl.ch)
//! @brief Test 4 for Implicit general quadrature.
//! @version 0.0.2
//! @date 2025-01-21
//!
...
TEST_CASE("General function quadrature for cylinder (3D)", "[impl]")
{
  ...
  for (int dir = 0; dir < 3; ++dir) {
    ...
    const auto cylinder = std::make_shared<funcs::Cylinder>(radius, origin, axis);
