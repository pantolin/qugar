...
class CustomQuadProtocol(Protocol):
...
class CustomQuadFacetProtocol(Protocol):
    """Data class for storing custom quadratures for a collection of
    facets.
...
class CustomQuad(NamedTuple):
    ...
    This class follows the `CustomQuadProtocol` protocol.
...
class CustomQuadFacet(NamedTuple):
    ...
    This class follows the `CustomQuadFacetProtocol` protocol.
