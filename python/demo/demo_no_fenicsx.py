...
To illustreate the capabilities, it creates different implicit domains (in 2D and 3D)
...
The computation of these integrals involves using the generated quadrfature points and weights in
